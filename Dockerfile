...
RUN GOOS=linux go build -ldflags '-linkmode=external' $BUILDFLAGS -v -o synthetic-service
...
COPY --from=builder /src/synthetic-service/synthetic-service /synthetic-service
